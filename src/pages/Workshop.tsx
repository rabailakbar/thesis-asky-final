    ...
    <div className="w-full p-8  flex  justify-center ">
      <div className="w-full pb-4 overflow-auto h-[90vh]  bg-[#F8F1E7] rounded-2xl shadow-xl ">
        ...
        <div className="bg-[#5F237B] text-white px-12  rounded-t-2xl flex justify-between items-center relative">
          ...
          <div className="py-10">
            <h1 className="text-[5vw] text-[#F8F1E7] font-extrabold leading-tight">
...
<div>
        ...
        <div className=" py-6 text-gray-700 leading-relaxed">
          <p className="mb-4 text-[#4C1C62] text-[1.25vw] ">
            A glow up for your brain. How does that sound?
          </p>

          <p className="text-[#4C1C62] text-[1.25vw]">
            We’re here to help. Turn curiosity into your superpower.
        ...
        <div className=" bg-[white] w-full p-4">
          ...
          <h2 className="text-[1.5vw] font-bold text-[#5F237B] mb-4">
            All Modules
          </h2>
...
const StatBox = (props ) => {
  return (
    ...
    >
        <div className="">
      <p className="font-extrabold text-[#D0193E]  text-[4.25vw]">{props.number}</p>
      </div>
      <div>
